...
$textbotlang['users']['number']['false'] = "❌ — شماره تلفن اشتباه!

شماره تلفن به درستی ارسال نشده است. لطفاً با استفاده از دکمه‌ی تعبیه شده در کیبورد ربات تلفن خود را تائید کنید.";
$textbotlang['users']['number']['Warning'] = "⚠️ — شماره تلفن نامعتبر

این شماره تلفن مربوط به این اکانت نیست، شماره تلفن ارسالی حتماً باید مربوط به همین اکانت تلگرامی باشد.";
$textbotlang['users']['number']['erroriran'] = "❌ — شماره تلفن غیر ایرانی!

شماره تلفن ارسالی شما نامعتبر است. تنها شماره تلفن‌های ایرانی برای استفاده از این ربات مجاز هستند.";
$textbotlang['users']['number']['active'] = "✅ — تائید موفق شماره موبایل!
شماره موبایل شما با موفقیت تائید و در سیستم ذخیره شد.";
$textbotlang['users']['number']['Confirming'] = "☎️ — تائید شماره تلفن همراه

لطفاً با استفاده از دکمه‌ی تعبیه شده پایین، شماره تلفن خود را در سیستم تائید کنید.";


$textbotlang['users']['sell']['service_not_available'] = "❌ شما هیچ سرویس فعالی ندارید.";
$textbotlang['users']['sell']['service_sell'] = "🛍 — اشتراک‌های خریداری شده توسط شما

⚠️برای مشاهده اطلاعات و مدیریت آن‌ها روی نام‌کاربری مدنظر کلیک کنید.";
...
$textbotlang['users']['sell']['None-credit'] = "⚠️ — پرداخت ناموفق

🗒 پرداخت به علت عدم موجودی کافی با خطا مواجه شد، لطفاً ابتدا به میزان مورد نیاز کیف‌پول خود را شارژ نمائید.

ℹ️ برای شارژ کیف‌پول خود یکی از روش‌های پرداخت زیر را انتخاب کنید:";
$textbotlang['users']['sell']['ErrorConfig'] = "⭕️ — خطای غیرمنتظره!

خطایی حین ساخت اشتراک شما رخ داد. برای بررسی و رفع مشکل با پشتیبانی ربات در ارتباط باشید.";
...
$textbotlang['users']['stateus']['notUsernameget'] = "🔎 جستجوی سریع";
$textbotlang['users']['stateus']['SendUsername'] = "🔎 — جستجوی سریع
لطفاً نام‌کاربری مدنظر را برای جستجو ارسال کنید:";
...
$textbotlang['users']['stateus']['daysleft'] = "زمان باقی‌مانده از سرویس: ";
$textbotlang['users']['stateus']['usedTrafficGb'] = "حجم استفاده شده: ";
$textbotlang['users']['stateus']['LastTraffic'] = "حجم کل سرویس: ";
$textbotlang['users']['stateus']['RemainingVolume'] = "حجم باقی‌مانده از سرویس: ";
$textbotlang['users']['stateus']['info'] = "📊 — اطلاعات سرویس: ";
$textbotlang['users']['stateus']['error'] = "⭕️ — خطایی رخ داد.";
$textbotlang['users']['stateus']['usernotfound'] = "⭕️ — کاربر در سرور وجود ندارد.";
...
$textbotlang['users']['Extra_volume']['extraadded'] = "✅ ترافیک خریداری شده با موفقیت به سرویس شما افزوده شد.";
$textbotlang['users']['Extra_volume']['extracheck'] = "تائید و دریافت ترافیک اضافه";
$textbotlang['users']['Extra_volume']['invalidprice'] = "حداقل ترافیک قابل خرید، یک گیگابایت می‌باشد.";
...
$textbotlang['users']['support']['sendmessageadmin'] = "📨 — پیام شما به مدیر ارسال شد؛ تا دریافت پاسخ منتظر بمانید.";
$textbotlang['users']['support']['answermessage'] = "پاسخ به پیام";
$textbotlang['users']['support']['sendmessageuser'] = "📨 برای ارتباط با پشتیبانی، پیام خود را ارسال نمائید:";
$textbotlang['users']['support']['btnsupport'] = "☎️ — به بخش پشتیبانی خوش آمدید.

در دکمه «سوالات متداول» پاسخ به سوالات پرتکرار شما آمده است.

لطفاً ابتدا قسمت سوالات متداول را مطالعه کنید، در صورتی که پاسخ سوال خود را نیافتید از گزینه‌ی «ارسال پیام به پشتیبانی» استفاده نمائید.";


$textbotlang['users']['Balance']['priceinput'] = "💵 — شارژ کیف پول!

برای ایجاد پیش‌فاکتور شارژ کیف‌پول، لطفاً مبلغ مدنظر را به تومان وارد کنید:";
$textbotlang['users']['Balance']['errorprice'] = "❌ خطا 
💬 لطفا فقط عدد وارد کنید
اعداد به صورت لاتین (کیبورد روی انگلیسی) باشد";
$textbotlang['users']['Balance']['errorpricelimit'] = sprintf("❌ — خطا
مبلغ قابل انتقال برای شارژ کیف پول باید حداقل %s تومان و حداکثر %s تومان باشد.", number_format(CARD_TRANSFER_AMOUNT_LIMIT['min']), number_format(CARD_TRANSFER_AMOUNT_LIMIT['max']));
...
$textbotlang['users']['selectusername'] = "یک نام‌کاربری برای سرویس خود به دلخواه ارسال نمائید.

⚠️: نام‌کاربری باید بدون کارکترهای اضافه مثل @، فاصله یا خط‌تیره وارد شود.
⚠️: تنها حروف انگلیسی مورد قبول است.";
$textbotlang['users']['invalidusername'] = "❌ عبارت وارد شده به عنوان نام‌کاربری معتبر نیست.

🔄 خواهشمند است با توجه به نکات گفته شده، مجدداً یک نام‌کاربری برای سرویس خود انتخاب نمائید.";
...
$textbotlang['Admin']['cpu_load_average'] = "🚀 میانگین لود سی‌پی‌یو";
